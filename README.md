...
float distanceCM;
WiFiClient client;
unsigned long myChannelField =  3168275; // Channel ID
const int ChannelField = 1; // Which channel to write data
const char * myWriteAPIKey = "MO2JEA7M2Z9E3DW5"; // Your write API Key
void setup()
{
Serial.begin(115200);
...
```
# CIRCUIT DIAGRAM:
![WhatsApp Image 2025-11-18 at 2 45 56 PM](https://github.com/user-attachments/assets/387f99df-f26a-45a5-85c8-0fba3b0d55cc)

# OUTPUT:

## SERIAL MONITOR:
<img width="1919" height="1198" alt="Screenshot 2025-11-18 144015" src="https://github.com/user-attachments/assets/a2be41b1-cc3f-4abe-9435-a7d9a1770f29" />

## THINGSPEAK:
<img width="1919" height="1058" alt="Screenshot 2025-11-18 144002" src="https://github.com/user-attachments/assets/d579a05f-524b-47f4-8b25-3405a19ed8b8" />
